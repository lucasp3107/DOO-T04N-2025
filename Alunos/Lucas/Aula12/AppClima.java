...
public class AppClima {
    ...
    public static void main(String[] args) {
        String chaveApi = System.getenv("API_KEY");

        if (chaveApi == null || chaveApi.isEmpty()) {
            System.out.println("Erro: variável de ambiente API_KEY não encontrada.");
            return;
        }
    ...
    private static String extrairPrimeiroObjeto(String texto) {
        Pattern pattern = Pattern.compile("\"days\"\s*:\s*\[(\{.*?\})", Pattern.DOTALL);
