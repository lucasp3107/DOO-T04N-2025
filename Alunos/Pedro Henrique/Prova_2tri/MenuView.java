package com.minhas_series_tv.view;
...
public class MenuView {
    ...
    public int exibirListaSeries(String tituloLista, List<Serie> series) {
        ...
        for (int i = 0; i < series.size(); i++) {
            Serie serie = series.get(i);
            // Formata a data de estreia para exibir melhor
        ...
        // Opção para remover uma série da lista específica
    ...
    // Métodos para feedback ao usuário
