...
public class Serie {
    ...
    public Serie(int id, String nome, String idioma, String[] generos, Double nota, String status, String dataEstreia, String dataTermino, String emissora, String resumo) {
        this.id = id;
        this.nome = nome;
        this.idioma = idioma;
